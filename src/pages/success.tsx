...
import { ImageContainer, SuccessContainer, ImageGrid } from "../styles/pages/success";
...
export default function Success({ costumerName, order }: SuccessProps) {
  ...
  const isEven = (order.length % 2) === 0 ? true : false
  ...
  return (
    <>
      ...
      <SuccessContainer>
        ...
        <p>
          Uhuul! <strong>{costumerName}</strong>, sua compra de {order.length} camisetas já está a caminho da sua casa.
        </p>
