...
export default function Product({ product }: ProductProps) {
  const { addProductIdToCart, cart: { productIds }, searchProductInCart } = useContext(CartContext)
    ...
    <>
      ...
      <ProductContainer>
        ...
        <ProductDetails>
          ...
          <button value={product.id} disabled={isProductInCart} onClick={handleBuyButton}>
