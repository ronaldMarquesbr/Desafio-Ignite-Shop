import { addProductIdToCartAction, addProductsToCartAction, removeProductToCartAction } from "@/reducers/cart/actions";
...
export function CartContextProvider({ children }: CartContextProviderProps) {
    ...
    return (
        <CartContext.Provider value={{cart, addProductIdToCart, addProductsToCart, removeProductToCart, searchProductInCart}}>
            { children }
